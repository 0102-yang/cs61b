 ...
 * @author Omar Khan
 */
public class AtLeastOneMoveExistsTest {
    ...
    public void testEmptySpace() {
        ...
        AtLeastOneMoveExistsTest.b = new Board(rawVals, 0);
        assertTrue("A tilt in any direction will change the board " + "(there is empty space on the board)\n"
                + AtLeastOneMoveExistsTest.b, Model.atLeastOneMoveExists(AtLeastOneMoveExistsTest.b));
    }
    ...
    public void testAnyDir() {
        ...
        AtLeastOneMoveExistsTest.b = new Board(rawVals, 0);
        assertTrue("A tilt in any direction will change the board\n" + AtLeastOneMoveExistsTest.b,
                Model.atLeastOneMoveExists(AtLeastOneMoveExistsTest.b));
    }
    ...
    public void testNoMoveExists5() {
        int[][] rawVals = new int[][]{{8, 16, 2, 32}, {32, 2, 64, 2}, {2, 256, 128, 256}, {1024, 8, 4, 2},};
