...
public class TestEmptySpace {
    ...
    public void testCompletelyEmpty() {
        ...
        TestEmptySpace.b = new Board(rawVals, 0);
        assertTrue(
                "Board is full of empty space\n" + TestEmptySpace.b,
                Model.emptySpaceExists(TestEmptySpace.b));
    }
    ...
    public void testEmptyTopRow() {
        ...
        assertTrue(
                "Top row is empty\n" + TestEmptySpace.b, Model.emptySpaceExists(TestEmptySpace.b));
    }
    ...
    @Test
    /**
     * Tests a completely full board. The game isn't over since you can merge, but the
     * emptySpaceExists method should only look for empty space (and not adjacent values).
     */
