 ...
 *
 * <p>You shouldn't expect to pass these tests until you're passing all the tests in TestEmptySpace.
 *
 * @author Omar Khan
 */
public class TestAtLeastOneMoveExists {
     ...
     *
     * <p>Note that this isn't a comprehensive test for empty space. For that, see the
     * TestEmptySpace class.
     */
    public void testEmptySpace() {
        ...
        TestAtLeastOneMoveExists.b = new Board(rawVals, 0);
        assertTrue(
                "A tilt in any direction will change the board "
                        + "(there is empty space on the board)\n"
                        + TestAtLeastOneMoveExists.b,
                Model.atLeastOneMoveExists(TestAtLeastOneMoveExists.b));
    }
     ...
     *
     * <p>While having the max tile on the board does mean the game is over, it should not be
