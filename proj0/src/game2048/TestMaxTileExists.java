...
public class TestMaxTileExists {
    ...
    public void testEmptyBoard() {
        ...
        TestMaxTileExists.b = new Board(rawVals, 0);

        assertFalse(
                "Board is empty\n" + TestMaxTileExists.b, Model.maxTileExists(TestMaxTileExists.b));
    }
    ...
    public void testFullBoardNoMax() {
        ...
        assertFalse(
                "No 2048 tile on board\n" + TestMaxTileExists.b,
                Model.maxTileExists(TestMaxTileExists.b));
    }
